            ...
            [
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Strong(result['Symbol']),
                                html.P(result['Text (Paragraph)']),
                                html.Div(
                                    [
                                        html.Span(result['Member'], className='time'),
                                        html.Span(result['Date'], className='author')
                                    ],
                                    className='info-row'
                                )
                            ],
                        ...
                        for _, result in matches.iterrows()
                    ]
                )
            ]
            )
